...
<center>
  ...
  <tr class="linear">
    ...
    <td><?=$row['CUname']?></td>
    <td><a href="CU-Modify.php?ID=<?=$row['ID']?>">修改</a></td>
  </tr>
  <?php } ?>
</table>
<form action="dispose/column-tan.php" method="post">
<table width="374" style=" text-align:center">
   <caption >添加栏目</caption>
   <tr class="linear">
    <td width="99">栏目名称</td>
    <td width="263">&nbsp;<input name="lm" type="text" size="36"></td>
  </tr>
</table>
