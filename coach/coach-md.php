...
<div class="dmidou">
  ...
  <br />
 		<center>
     <form action="Cmd-up.php?ID=<?=$row['CID']?>" method="post" enctype="multipart/form-data">
    <table width="397"  cellspacing="0"  >
	<caption style="color:#0EA8F3;">修改信息</caption>
  <tbody>
    <tr>
    ...
    <tr>
      ...
      <td   class="tdi2" style="border-bottom-color:#0EA8F3;"><input type="text" name="name" value="<?=$row['Cname']?>" ></td>
      </tr>
    <tr>
      <td height="40" class="td1" style="color:#0EA8F3;">性别：</td>
      <td class="tdi2"style="border-bottom-color:#0EA8F3;"><input type="text" name="sex" value="<?=$row['Csex']?>"></td>
      </tr>
    <tr>
      <td height="40" class="td1" style="color:#0EA8F3;">出生年月：</td>
      <td class="tdi2" style="border-bottom-color:#0EA8F3;"><input type="text" name="bir" value="<?=$row['Cbir']?>"></td>
      </tr>
    <tr>
      <td height="40" class="td1" style="color:#0EA8F3;" >预留手机号：</td>
      <td class="tdi2" style="border-bottom-color:#0EA8F3;"><input type="text" name="ph" value="<?=$row['phone']?>"></td>
      </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="tdi2" style="border-bottom-color:#0EA8F3;"><input type="text" name="address" value="<?=$row['Caddress']?>"></td>
      </tr>
    <tr>
      <td height="50" class="td1" style="color:#0EA8F3;">擅长：</td>
      <td class="tdi2" style="border-bottom-color:#0EA8F3;" ><input type="text" name="hy" value="<?=$row['Cnice']?>"></td>
      </tr>
    </tbody>
   </table> 
  <p> <input name="mx" type="submit"  value="修改"  class="bottun"/></p>
  </from>  
</center>
  </div>
  </div>
