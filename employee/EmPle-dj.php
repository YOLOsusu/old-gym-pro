...
<div class="dmidou">
 ...
 <div  class="dright">
    <div class="MD">
    <form action="EmPle-dj.php" method="post">
    ...
    if(isset($_POST['DID'])&&$_POST['DID']!=""){
      ...
      if($aff1>=0){
         ...
         <a href="djint.php?ID=<?=$row1['MID']?>"><input type="button" value="登记"></a>
         <?php
        }else{
        echo "无该会员号";
    ...
    if(isset($_POST['name'])&&$_POST['name']!=""){
      ...
      if($aff2>0){
         ...
         性别：<?=$row2['Msex']?><br>
         <span style="color:<?=$color?>"><?=$str?></span><br>
         <a href="djint.php?ID=<?=$row2['MID']?>"><input type="button" value="登记"></a>
         <?php
      }else{
       echo "无该会员";
