...
<div class="dmidou">
  <div  class="dleft">
      ...
      <a herf="EmPle-xx.php"><div class="ddli"> 员工信息</div></a> 
 ...
 <div  class="dright">
  <form action="EmPle-up.php?ID=<?=$row['ID']?>" method="post">       
 <center>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td   class="tdi2"><input type="text" name="name" value="<?=$row['name']?>"></td>
      </tr>
    <tr>
      <td height="40" class="td1">性别：</td>
      <td class="tdi2"><input type="text" name="sex" value="<?=$row['Esex']?>"></td>
      </tr>
    <tr>
      <td height="40" class="td1" >预留手机号：</td>
      <td class="tdi2"><input type="text" name="ph" value="<?=$row['phone']?>"></td>
      </tr>
    <tr>
      <td height="50" class="td1">家庭住址：</td>
      <td class="tdi2"><input type="text" name="add" value="<?=$row['address']?>"></td>
    </tr>
  </tbody>
</table> 
<p><input name="mx" type="submit"  value="提交" class="bottun" /></p>
</center>
</from>
